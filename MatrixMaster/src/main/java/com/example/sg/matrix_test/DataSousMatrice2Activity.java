...
public class DataSousMatrice2Activity extends Activity {
        ...
        public void onClick(View view) {
            ...
            for (EditText e : editTextList) {
                if (e.getText().toString().equals("")) {
                    Toast.makeText(DataSousMatrice2Activity.this, "Veuiller remplir tous les champs", Toast.LENGTH_SHORT).show();
                    suivi = false;
                    break;
                }
            }
            if (suivi) {
                ...
                Intent intent = new Intent(DataSousMatrice2Activity.this, AfficheSoustractionActivity.class);
