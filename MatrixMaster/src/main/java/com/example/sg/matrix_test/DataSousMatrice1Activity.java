...
public class DataSousMatrice1Activity extends Activity {
        ...
        public void onClick(View view) {
            ...
            for (EditText e : editTextList) {
                if (e.getText().toString().equals("")) {
                    Toast.makeText(DataSousMatrice1Activity.this, "Veuiller remplir tous les champs", Toast.LENGTH_SHORT).show();
                    suivi = false;
                    break;
                }
            }
            if (suivi) {
                ...
                Intent intent = new Intent(DataSousMatrice1Activity.this, DataSousMatrice2Activity.class);
