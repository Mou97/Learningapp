...
public class DataAddMatrice1Activity extends Activity {
    ...
    private Button submitButton() {
        ...
        button.setLayoutParams(new LayoutParams(660, 210));
        return button;
    }
        ...
        public void onClick(View view) {
            ...
            for (EditText e : editTextList) {
                if (e.getText().toString().equals("")) {
                    Toast.makeText(DataAddMatrice1Activity.this, "Veuiller remplir tous les champs", Toast.LENGTH_SHORT).show();
                    suivi = false;
                    break;
                }
            }
            if (suivi) {
                ...
                Intent intent = new Intent(DataAddMatrice1Activity.this, DataAddMatrice2Activity.class);
