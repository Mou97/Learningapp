...
public class DataMultiMatrice2Activity extends Activity {
    private List<EditText> editTextList = new ArrayList<EditText>();

    int rows, columns, rowsprime, columnsprime, rows1, columns1;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        rows = intent.getIntExtra("nbrRow2", 0);
        columns = intent.getIntExtra("nbrColumn2", 0);
        ...
        public void onClick(View view) {
            ...
            for (EditText e : editTextList) {
                if (e.getText().toString().equals("")) {
                    Toast.makeText(DataMultiMatrice2Activity.this, "Veuiller remplir tous les champs", Toast.LENGTH_SHORT).show();
                    suivi = false;
                    break;
                }
            }
            if (suivi) {
                ...
                Intent intent = new Intent(DataMultiMatrice2Activity.this, AfficheMultiMatriceActivity.class);
                intent.putExtra("dataMatrice2", data);
                intent.putExtra("dataMatrice1", datamat1);

                intent.putExtra("nbrRow1", rows1);
                intent.putExtra("nbrRow2", rowsprime);
                intent.putExtra("nbrColumn1", columns1);
                intent.putExtra("nbrColumn2", columnsprime);
