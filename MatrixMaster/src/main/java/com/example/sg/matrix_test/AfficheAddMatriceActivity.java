...
public class AfficheAddMatriceActivity extends AppCompatActivity {
    int rows1, columns1;
    TextView textView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_affiche_add_matrice);
        ...
        Matrix resultMulti = MatrixCalcule.add(matrice1, matrice2);
