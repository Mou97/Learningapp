...
public class DataTransposeActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        columns = intent.getIntExtra("columns", columns);
        ...
        public void onClick(View view) {
            ...
            for (EditText e : editTextList) {
                if (e.getText().toString().equals("")) {
                    Toast.makeText(DataTransposeActivity.this, "Veuiller remplir tous les champs", Toast.LENGTH_SHORT).show();
                    suivi = false;
                    break;
                }
            }
            if (suivi) {
                ...
                Intent intent = new Intent(DataTransposeActivity.this, AfficheTransposeActivity.class);
                intent.putExtra("rows", columnsprime);
                intent.putExtra("columns", rowsprime);
